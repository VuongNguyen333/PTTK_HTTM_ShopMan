...
public class NhanVienQuanLy803 extends ThanhVien803{
    private int id;
    private int thanhVienId;
    private String trangThai;
    private LocalDateTime ngayVaoLam;

    public NhanVienQuanLy803(String username, String password, String hoTen, String diaChi, String soDienThoai, String ngaySinh, String gioiTinh, String vaiTro, int thanhVienId, String trangThai, LocalDateTime ngayVaoLam) {
